...
lm.fit2 = lm(mpg~poly(horsepower,2), data = Auto, subset = train) # Quadratic fit
mean((mpg-predict(lm.fit2,Auto))[-train]^2)

# Cubic Regression
lm.fit3 = lm(mpg~poly(horsepower,3), data = Auto, subset = train) # Cubic fit
