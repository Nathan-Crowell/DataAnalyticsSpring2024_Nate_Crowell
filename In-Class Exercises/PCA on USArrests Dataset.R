...
# Note that the apply() function allows us to apply a function
# —in this case, the mean() function 
# to each row or column of the data set. 
# The second input here denotes whether we wish to compute 
# the mean of the rows, 1, or the columns, 2. 
...
# We can aalso examine the variances of the variables
apply(USArrests, 2, var)

# Not surprisingly, the variables also have vastly different variances:
# the UrbanPop variable measures the percentage of the population 
# in each state living in an urban area, which is not a comparable number to 
# the number of rapes in each state per 100,000 individuals. 
...
# each column of pr.out$rotation contains 
